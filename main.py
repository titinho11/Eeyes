...
while rep == "yes":
    ...
    print("\033[37m")
    os.system(command)
    print("Les pvs sont generes sur le bureau dans le dossier Images.")
    print("Vous pouvez donc acceder a la plateforme dans le dossier eeyesviews et les uploader un a un.")
    print("Les resultats se mettent a jour apres chaque upload.")
    print("Allez-y et uploadez quelques proces verbaux !")
    ...
    print("\033[37m")
    if res == "yes":
        os.system("python3 sendPvs.py ~/Desktop http://localhost/api/uploadPv")

    print("Accedez a la plateforme depuis le repertoire eeyesviews/ et consultez les resultats !!")
    print("------------------------------------------------------")
...
os.system("sudo sh stopNetwork.sh")
